...
mn_cities <- st_read("/Users/josephsaputra/Documents/GitHub/ds212-portfolio-josaputra15/ica/04_adv_maps/data/City_And_Township_Population_Centers/City_And_Township_Population_Centers.shp")
mn_water <- st_read("/Users/josephsaputra/Documents/GitHub/ds212-portfolio-josaputra15/ica/04_adv_maps/data/Lakes_and_Rivers/Lakes_and_Rivers.shp")
```
...
> d for categorical, c for heatmap with no obvious separation of the variable value group, b is for heatmap with an obvious separation of the variable value group
